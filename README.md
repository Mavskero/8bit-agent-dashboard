...
Agent 在无任务且没有音乐播放时，每轮闲置动作以 10% 概率进入品茶，其余时间使用待机打字；品茶的闭眼停留段约 1 秒。打字动画包含双手手指敲击，六帧中仅一帧眨眼；思考动画保持人物注视电脑，由脸颊侧逐步冒出气泡和发光灯泡。打字、思考和完成动作共享同一躯干/电脑基准帧。人物素材以高质量透明插值缩放，在非整数显示尺寸下平滑融合边缘。
